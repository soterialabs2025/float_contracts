...
/// @notice Per-vault LiquidSharesSv3 staking with fixed-length epochs.
...
contract ShareStakingSv3 is Ownable, ReentrancyGuard, IShareStakingSv3 {
    ...
    function bootstrap(
        ...
        liquidShares = ILiquidSharesSv3(liquidShares_);
        strategy = strategy_;
        asset = asset_;
    ...
    /// @notice Withdraw LiquidSharesSv3. Reverts until `lockedUntil` (end of epoch in which stake was acquired).
