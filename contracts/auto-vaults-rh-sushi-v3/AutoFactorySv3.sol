...
contract AutoFactorySv3 is Ownable {
    ...
    constructor(InfraConfig memory config) Ownable(msg.sender) {
        ...
        vaultImplementation = address(new AutoVaultSv3());
        liquidSharesImplementation = address(new LiquidSharesSv3());
        shareStakingImplementation = address(new ShareStakingSv3());
    }
