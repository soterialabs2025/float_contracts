...
contract SoteriaFeeManagerSushi is Ownable, ReentrancyGuard {
    ...
    constructor(address initialOperator) Ownable(msg.sender) {
        ...
        // No Sushi SwapRouter02 on RH — set via setV3SwapRouter (e.g. AutoSwapRouterSushiV3 + auth) when needed.
        v3SwapRouter = ISwapRouterV3(address(0));
