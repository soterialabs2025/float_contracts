...
import "./interfaces/IAutoVaultSv3.sol";
import "./interfaces/IAutoStrategySv3.sol";
import "./interfaces/ILiquidSharesSv3.sol";

interface IWETHSushiV3 is IERC20 {
    function deposit() external payable;
}

/// @title AutoVaultSv3
/// @notice RH Sushi V3 AutoVault: ETH-only deposits (aeWETH wrap), LiquidSharesSv3 + ShareStakingSv3 package.
contract AutoVaultSv3 is Ownable, ReentrancyGuard, IAutoVaultSv3 {
    using SafeERC20 for IERC20;

    IWETHSushiV3 public immutable weth;
    IAutoStrategySv3 public strategy;
    ...
    constructor(address factory_) Ownable(msg.sender) {
        ...
        factory = factory_;
        weth = IWETHSushiV3(SushiV3Deployments4663.WETH);
    }
    ...
    function bootstrap(
        ...
        strategy = IAutoStrategySv3(strategy_);
    ...
    function withdraw(uint256 shares, bool asAsset) external override nonReentrant returns (uint256) {
        ...
        IAutoStrategySv3.WithdrawToken out =
            asAsset ? IAutoStrategySv3.WithdrawToken.ASSET : IAutoStrategySv3.WithdrawToken.WETH;
        _syncAcc();
