...
contract AutoVaultSushiV3 is Ownable, ReentrancyGuard, Pausable, IAutoVaultV2 {
    using SafeERC20 for IERC20;

    IWETHSushiV3 public immutable weth;
    IAutoStrategySushiV3 public strategy;
    ...
    function bootstrap(
        ...
        factory = msg.sender;
        strategy = IAutoStrategySushiV3(strategy_);
    ...
    function withdraw(uint256 shares, bool asAsset) external override nonReentrant whenNotPaused returns (uint256) {
        ...
        IAutoStrategySushiV3.WithdrawToken out =
            asAsset ? IAutoStrategySushiV3.WithdrawToken.ASSET : IAutoStrategySushiV3.WithdrawToken.WETH;
