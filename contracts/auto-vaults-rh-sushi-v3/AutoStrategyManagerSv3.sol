...
contract AutoStrategyManagerSv3 is Ownable {
    ...
    /// @notice Share of protocolFeeBps proceeds sent to ShareStakingSv3 (rest to feeManager). Default 75%.
