...
/// @notice Base Uniswap V3 swap router for UFloatStrategyV3. Per-asset fee registry (no PoolKey).
contract UFloatSwapRouterV3 is IUFloatV3StrategySwapRouter, Ownable, ReentrancyGuard {
    ...
    IUniswapV3Factory public immutable v3Factory = IUniswapV3Factory(V3Deployments8453.FACTORY);
    address public immutable weth = V3Deployments8453.WETH;
