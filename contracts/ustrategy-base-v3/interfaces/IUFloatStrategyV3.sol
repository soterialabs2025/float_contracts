...
/// @title IUFloatStrategyV3
/// @notice Standalone v3 strategy (no FloatVault / share token). Owner funds via ETH; withdraws WETH.
interface IUFloatStrategyV3 is IUFloatStrategyAllowedTokens {
    ...
    /// @notice Rotate to `_newAssetAddr` (or WETH for STABLE exit). Pool fee is read from the V3 strategy swap router.
