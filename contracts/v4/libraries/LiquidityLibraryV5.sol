...
/// @title LiquidityLibraryV5
/// @notice Uniswap V4 LP helpers with increase capped to explicit amounts (deployable balances).
library LiquidityLibraryV5 {
    ...
    /// @param amount0Max Cap for currency0 (e.g. deployable); also capped to on-strategy balance.
    /// @param amount1Max Cap for currency1 (e.g. deployable); also capped to on-strategy balance.
