...
/// @notice Receives protocol fee tokens/ETH, swaps to WETH/USDC, and forwards to treasury or partner.
contract SoteriaFeeManager is Ownable, ReentrancyGuard {
    using SafeERC20 for IERC20;

    IWETH public immutable WETH = IWETH(V4Deployments8453.WETH);
    ...
    IERC20 public usdc;
    uint24 public v3DefaultFee = 3000;
    ...
    /// @notice Wrap the contract's full ETH balance to WETH.
    ...
    /// @param asUsdc true → send full USDC balance; false → send full WETH balance.
    ...
    /// @param asUsdc true → send full USDC balance; false → send full native ETH balance.
