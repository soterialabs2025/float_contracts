...
/// @title ShareStaking
/// @notice Per-vault LiquidShares staking with fixed-length epochs (RH V4).
...
///      ASSET→WETH uses AutoSwapRouter with the package PoolKey (not native ETH pairs).
contract ShareStaking is Ownable, ReentrancyGuard, IShareStaking {
