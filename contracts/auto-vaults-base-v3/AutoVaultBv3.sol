...
/// @title AutoVaultBv3
/// @notice Base (8453) AutoVault: ETH-only deposits, LiquidSharesBv3 + ShareStakingBv3 package, ownership lock.
contract AutoVaultBv3 is Ownable, ReentrancyGuard, IAutoVaultBv3 {   
    using SafeERC20 for IERC20;

    IWETH public immutable weth;
    IAutoStrategyBv3 public strategy;
    ...
    constructor(address factory_) Ownable(msg.sender) {
        ...
        factory = factory_;
        weth = IWETH(V3Deployments8453.WETH);
    }
    ...
    function bootstrap(
        ...
        strategy = IAutoStrategyBv3(strategy_);
    ...
    function withdraw(uint256 shares, bool asAsset) external override nonReentrant returns (uint256) {
        ...
        IAutoStrategyBv3.WithdrawToken out =
            asAsset ? IAutoStrategyBv3.WithdrawToken.ASSET : IAutoStrategyBv3.WithdrawToken.WETH;
        _syncAcc();
