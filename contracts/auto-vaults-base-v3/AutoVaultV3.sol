...
import "./interfaces/IAutoStrategyV3.sol";
...
contract AutoVaultV3 is Ownable, ReentrancyGuard, Pausable, IAutoVaultV2 {
    using SafeERC20 for IERC20;

    IWETH public immutable weth;
    IAutoStrategyV3 public strategy;
    ...
    function bootstrap(
        ...
        factory = msg.sender;
        strategy = IAutoStrategyV3(strategy_);
    ...
    function withdraw(uint256 shares, bool asAsset) external override nonReentrant whenNotPaused returns (uint256) {
        ...
        IAutoStrategyV3.WithdrawToken out =
            asAsset ? IAutoStrategyV3.WithdrawToken.ASSET : IAutoStrategyV3.WithdrawToken.WETH;
