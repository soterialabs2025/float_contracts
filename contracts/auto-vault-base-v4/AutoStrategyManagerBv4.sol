...
contract AutoStrategyManagerBv4 is Ownable {
    ...
    // the strategy derives it from them (`LiquidityLibraryV4.mintShare`); a hand-set target could only agree with
    ...
    uint256 public maxSwapTickDeviation = 1000;
