...
interface IAutoKeeper {
    ...
    /// @notice Harvest then snapshot vault NAV + UniswapFeesCollected for watched strategy `id`.
    function snapshotVaultPoolValue(uint256 id, bool skipIncreaseLiquidity) external;
}
