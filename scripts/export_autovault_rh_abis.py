...
PACKAGES: list[tuple[str, str, str, list[tuple[str, str | None]]]] = [
    (
        ...
        [
            ...
            ("AutoFactoryRhV3", "0xeCad673d6B338D9b530401105332FFD55D35696F"),
            ("AutoSwapRouterRhV3", "0xB76cdfF814220334Bb46C247F5D7f5d6bE7c8d3B"),
            ("AutoKeeperRhV3", "0x6ef6afF9Dc71202252B9A0c95E1193aD7D1e5795"),
